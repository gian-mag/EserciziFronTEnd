...
var Abbigliamento = /** @class */ (function () {
    function Abbigliamento(id, codprod, collezione, capo, modello, quantità, colore, prezzoivaesclusa, prezzoivainclusa, disponibile, saldo) {
        this.id = id;
    ...
    Abbigliamento.prototype.getsaldocapo = function () {
        return this.prezzoivainclusa - (this.saldo * this.prezzoivainclusa);
    };
...
var capi = [];
var url = "http://localhost:3000/capi";
